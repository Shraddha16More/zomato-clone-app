...
export function Checkout() {
  ...
  return (
    <div className="p-32">
      <h1 className="text-lg text-center" style={{ fontSize: "2rem" }}>
        Checkout
      </h1>
      <div>
        <div
        ...
        <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
          <div class="px-4 pt-8">
            ...
            <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6 overflow-auto max-h-80">
              ...
              {cartData?.map((cart) => {
                return (
                  <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                    ...
                    />
                    <div class="flex w-full flex-col px-4 py-4">
                      <span class="font-semibold">{cart.nameOfTheDish}</span>
                      <span class="float-right text-gray-400">
                        {cart.length > 30
                          ? cart.description.substring(0, 30)
                          : cart.description}
                      </span>
